...
namespace Toolkit
{
    ...
    using Toolkit.HttpContextService;
    ...
    public static class Tools
    {
        ...
        /// 网络请求
        /// </summary>
        public static HttpRequest _httpRequest => new HttpRequest();
        ...
        {
            return await _httpRequest.PostObjectAsync<T>(Url, Data);
        }
        ...
        {
            return await _httpRequest.GetObjectAsync<T>(Url);
        }
