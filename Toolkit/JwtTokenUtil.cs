...
namespace Toolkit
{
    ...
    public class JwtTokenUtil
    {
        ...
        public string GetToken(string Key)
        {
            ...
            var key = new SymmetricSecurityKey(Encoding.UTF8.GetBytes(AppConfig.AdminAppConfig.JwtSecurityKey)); // 获取密钥
            ...
            var token = new JwtSecurityToken(
                issuer: AppConfig.AdminAppConfig.JwtKeyName,
                audience: AppConfig.AdminAppConfig.JwtKeyName,
                claims: claims,
