...
namespace Toolkit.VerificationCode
{
    /// <summary>
    /// 验证码类
    /// </summary>
        ...
        private Font[] fonts =
    {
       ...
       new Font(new FontFamily("Comic Sans MS"), 10 + Next(1),FontStyle.Regular)
        ...
        #region 构造函数
        public Helper(int number = 4)
        {
            // Tools.HttpHelper.Response.Headers.Add("pragma", "no-cache");
            //Tools.HttpHelper.Response
            //HttpContext.Current.Response.Expires = 0;
            //HttpContext.Current.Response.Buffer = true;
            //HttpContext.Current.Response.ExpiresAbsolute = DateTime.Now.AddSeconds(-1);
            //HttpContext.Current.Response.AddHeader("pragma", "no-cache");
            //HttpContext.Current.Response.CacheControl = "no-cache";
            this.text = Class.Str(number);//Class.Number(number);
            CreateImage();
        }
        #endregion
        ...
        public byte[] GetBytes()
        {
            ...
            this.image.Save(ms, System.Drawing.Imaging.ImageFormat.Bmp);
